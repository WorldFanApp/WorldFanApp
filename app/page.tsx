...
import { Music, Globe, Users, Ticket, Smartphone, TestTube } from "lucide-react"
        ...
        <div className="container mx-auto px-4 py-8">
          ...
          <div className="grid md:grid-cols-3 gap-8 mb-16">
            ...
            <Card className="border-0 shadow-lg hover:shadow-xl transition-shadow">
              ...
              <CardContent>
                <p className="text-gray-600">
                  Direct communication channels with artists and exclusive fan experiences.
                </p>
              </CardContent>
            </Card>
          </div>
          ...
          <Card className="border-0 shadow-xl bg-gray-50">
            <CardContent className="p-8 text-center">
              ...
              <p className="text-gray-600 mb-6 max-w-2xl mx-auto">
                ...
                World ID ensures you're a real fan, not a bot.
              </p>
              <Button
                size="lg"
