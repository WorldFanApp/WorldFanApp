...
export function Dashboard({ user }: DashboardProps) {
  ...
  const [referralData] = useState({
    referralCode: `WORLDFAN${user.id.slice(-6).toUpperCase()}`,
          ...
          <div className="flex items-center gap-4">
            <div className="flex items-center gap-2 px-3 py-1 bg-green-100 rounded-full">
              ...
              <span className="text-sm font-medium text-green-800">
                World ID Verified ({user.worldcoin?.verification_level})
              </span>
            </div>
              ...
              <CardContent className="space-y-6">
                <div className="grid gap-4">
                  <div>
                    ...
                    <Input id="username" value={user.name || ""} readOnly className="bg-gray-50" />
                  </div>
                  <div>
                ...
                <div className="border-t pt-6">
                  <div className="flex items-center justify-between p-4 bg-green-50 rounded-lg">
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        <p className="font-medium">World ID Verified Account</p>
                        <p className="text-sm text-gray-600">
                          Verification Level: {user.worldcoin?.verification_level}
                        </p>
